#ifndef __VISION_BASED_ROOF_LOCALIZER_HH__
#define __VISION_BASED_ROOF_LOCALIZER_HH__
...
class VisionBasedRoofLocalizer{
	private:
	...
	public:
		// 
		VisionBasedRoofLocalizer(int num_feats = 100, int history_len = 7, 
