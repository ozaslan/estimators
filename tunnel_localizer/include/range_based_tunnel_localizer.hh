...
private:
	...
	double _fitness_scores[3];	// average of large residuals (see the ### ??? function for detailed explanation)
	double _max_iters;			// maximum iterations of the ICP algorithm.
	double _yz_tol;				// translational tolerance value if updates of ICP is lower than which, iteration is stopped.
...
public:
	...
	// ### To be implemented.
	bool set_octree(const pcl::octree::OctreePointCloudSearch<pcl::PointXYZ> &octree_search);
